...
import PNLARThree13 from "./components/PNLARThree13";
import PNLARThree16 from "./components/PNLARThree16";
import PNLARThree19 from "./components/PNLARThree19";
...
class ScanTheObject2 extends Component{
	...
	getMarkerInfo(marker) {
		...
		const arData = getMarkerData(marker, 2) || {};
