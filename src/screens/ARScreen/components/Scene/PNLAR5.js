...
class PNLAR5 extends Component {
	constructor(props) {
		super(props);
		const markers = getMarkers(5);
	...
	getMarkerInfo(marker) {
		...
		const arData = getMarkerData(marker, 5) || {};
...
export default connect(mapStateToProps, mapDispatchToProps)(PNLAR5)
